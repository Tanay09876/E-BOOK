  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col">
      <header className="h-14 md:h-16 bg-white/80 backdrop-blur-md border-b border-gray-200 px-4 md:px-6 flex justify-between items-center sticky top-0 z-20 shrink-0">
        ...
        <Link
          to="/dashboard"
          className="inline-flex items-center gap-x-2 md:gap-x-3 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 rounded-lg"
        >
          <span className="size-7 md:size-8 bg-linear-to-br from-blue-400 to-blue-500 rounded-lg shadow-lg shadow-blue-500/20 flex justify-center items-center transition-all duration-300 group-hover:shadow-blue-500/40 group-focus-visible:shadow-blue-500/40 group-hover:scale-105 group-focus-visible:scale-105">
