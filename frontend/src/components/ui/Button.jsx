...
const variants = {
  primary:
    "bg-linear-to-r from-blue-600  to-indigo-600 text-white shadow-lg shadow-blue-500/30  hover:shadow-blue-500/50  hover:from-blue-700  hover:to-indigo-700  focus:ring-2 focus:ring-blue-500  focus:ring-offset-2",
  ...
  link: "bg-transparent text-blue-600 underline-offset-4 hover:underline focus-visible:underline p-0",
};
