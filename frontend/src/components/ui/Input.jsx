    ...
    <div className="w-full grid grid-cols-1 gap-y-2">
      ...
      <div className="relative">
        ...
        <input
          ...
          id={name}
          name={name}
          className={`w-full h-11 bg-white text-gray-900 text-sm placeholder-gray-400 px-3 py-2 border rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${
            InputIcon ? "pl-10" : ""
