      ...
      {step === 1 && (
        <div className="space-y-4 md:space-y-5">
          ...
          <ol className="flex items-center gap-2 mb-4 md:mb-6">
            <li
              aria-label="Step 1"
              className="size-7 md:size-8 bg-blue-100 text-blue-600 text-xs md:text-sm font-semibold rounded-full flex justify-center items-center"
            >
              1
            </li>
              ...
              chapters.map(({ title, description }, index) => (
                ...
                >
                  <div className="mb-2 md:mb-3 flex items-start gap-2 md:gap-3">
                    <div className="shrink-0 size-5 md:size-6 bg-blue-50 text-blue-600 text-xs font-semibold rounded-full mt-1 flex justify-center items-center">
                      {index + 1}
                    </div>
