      ...
      <section className="bg-white border border-slate-200 rounded-xl p-4 sm:p-6 mt-6 sm:mt-8 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
          ...
          {coverImageUrl ? (
            ...
            <div className="w-full sm:w-32 h-48 bg-linear-to-br from-blue-50 to-purple-50 border-2 border-dashed border-blue-200 rounded-lg shadow-sm flex flex-col items-center justify-center gap-2 p-4">
