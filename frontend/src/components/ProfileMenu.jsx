...
const ProfileMenu = ({
  ...
  <nav onClick={(event) => event.stopPropagation()} className="relative">
    <button
      ...
      className="rounded-xl p-2 inline-flex items-center gap-x-2 md:gap-x-3 transition-colors duration-200 hover:bg-gray-50 focus-visible:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
    >
      {avatarUrl ? (
        <img
        ...
        <span className="size-8 md:size-9 bg-linear-to-br from-blue-400 to-blue-500 rounded-xl inline-flex justify-center items-center shrink-0">
      ...
      <span className="hidden md:inline-flex md:flex-col text-left min-w-0 max-w-45">
