...
import { Mail, User2, Camera, Trash2, ArrowLeft } from "lucide-react";
...
function ProfilePage() {
  ...
  return (
    ...
    <button
      ...
      className="inline-flex items-center gap-2 text-lg font-medium text-blue-600 hover:text-blue-700 transition-colors"
    >
            ...
            <div className="flex flex-col items-center gap-6 pb-6 border-b border-slate-100">
              <div className="relative group">
                {avatarPreview ? (
                  <img
                    src={avatarPreview}
                    alt="Profile avatar"
                    className="size-24 sm:size-28 object-cover rounded-full ring-4 ring-blue-100 transition-all duration-200 group-hover:ring-blue-200"
                  />
                ) : (
                  <div className="size-24 sm:size-28 bg-linear-to-br from-blue-400 to-blue-500 rounded-full ring-4 ring-blue-100 flex items-center justify-center transition-all duration-200 group-hover:ring-blue-200">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-lg transition-all duration-200 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
